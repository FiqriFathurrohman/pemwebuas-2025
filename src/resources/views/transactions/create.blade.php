...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-md-8 text-center mb-4">
            <img src="{{ asset('images/washcar.png') }}" alt="WashCar Logo" class="img-fluid mb-3" style="max-width: 250px;">
            <h2 class="fw-bold text-primary">Tambah Transaksi Baru</h2>
            <p class="text-muted">Isi form di bawah untuk mencatat transaksi cuci mobil</p>
        </div>
            ...
            <div class="card shadow-lg border-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('transactions.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Kategori Mobil</label>
